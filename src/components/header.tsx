...
export function Header() {
  return (
    <header className='flex justify-center font-medium text-base items-center pt-16 pb-32 md:pb-40 w-full mx-auto'>
      <nav className='flex flex-row text-neutral-100 items-center justify-center text-center border border-white/10 bg-white/5 shadow-xl shadow-white/5 rounded-xl'>
